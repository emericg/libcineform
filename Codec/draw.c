...

    {
        ...
        for (y = y1; y <= y2; y++)
        {
            ...
            for (x = x1, xpos = 0; x < xa; x++)
            {
                ...
                //if(val > bptr[x * 4 + 2])
                {
                    if ((bptr[x * 4 + 0] + val / 2) < 256)	bptr[x * 4 + 0] += val / 2;
                    else bptr[x * 4 + 0] = 255; //blu
                    if ((bptr[x * 4 + 1] + val / 2) < 256)	bptr[x * 4 + 1] += val / 2;
                    else bptr[x * 4 + 1] = 255; //grn
                    if ((bptr[x * 4 + 2] + val) < 256)		bptr[x * 4 + 2] += val;
                    else bptr[x * 4 + 2] = 255; //red
                }
                //bptr[x * 4 + 3] = alpha;
            ...
            for (x = xa, xpos = 0; x < xb; x++)
            {
                ...
                //if(val > bptr[x * 4 + 1])
                {
                    ...
                    if ((bptr[x * 4 + 1] + val) < 256)		bptr[x * 4 + 1] += val;
                    else bptr[x * 4 + 1] = 255; //grn
                    if ((bptr[x * 4 + 2] + val / 2) < 256)	bptr[x * 4 + 2] += val / 2;
                    else bptr[x * 4 + 2] = 255; //red
                }
                //bptr[x * 4 + 3] = alpha;
                xpos = xpos2;
            ...
            for (x = xb, xpos = 0; x <= x2; x++)
            {
                ...
                //if(val > bptr[x * 4 + 0])
                {
                    if ((bptr[x * 4 + 0] + val) < 256)		bptr[x * 4 + 0] += val;
                    else bptr[x * 4 + 0] = 255; //blu
                    if ((bptr[x * 4 + 1] + val / 2) < 256)	bptr[x * 4 + 1] += val / 2;
                    else bptr[x * 4 + 1] = 255; //grn
                    if ((bptr[x * 4 + 2] + val / 2) < 256)	bptr[x * 4 + 2] += val / 2;
